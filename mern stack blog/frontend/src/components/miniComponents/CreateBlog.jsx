      ...
      <div className="container">
        <form onSubmit={handleBlog}>
          ...
          <div style={{ display: "flex", flexDirection: "column" }}>
            ...
            <img
              src={mainImagePreview ? `${mainImagePreview}` : "imgled.jpeg"}
              alt="mainImg"
              className="mainImg"
            />
            <input
          ...
          <div className="sub-para">
            ...
            <img
              src={
                paraOneImagePreview ? `${paraOneImagePreview}` : "imgled.jpeg"
              }
              alt="subParaOneImg"
            />
            <input
          ...
          <div className="sub-para">
            ...
            <img
              src={
                paraTwoImagePreview ? `${paraTwoImagePreview}` : "imgled.jpeg"
              }
              alt="subParaTwoImg"
            />
            <input
